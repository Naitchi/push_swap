...
/*   Updated: 2026/01/13 10:40:24 by cydupire         ###   ########lyon.fr   */
/*                                                                            */
/* ************************************************************************** */

#include "../push_swap.h"

void	min_mngmt(t_data *data, t_bench *bench, unsigned int min)
{
	while (data->a->index != min)
	{
		if (rot_or_rev(data->a, min) == 0)
